-- ==========================================
-- MIGRATION: Fix RLS Function Volatility and Joins
-- ==========================================
-- The RLS functions were marked STABLE but should be VOLATILE
-- since they check changing database state (admin_regions table)
-- Also fixes incorrect role-permission join
...
-- Recreate user_has_access_to_palika with VOLATILE (not STABLE)
...
-- Recreate user_has_permission with proper role join and VOLATILE
...
-- Recreate user_has_access_to_district with VOLATILE
...
-- Recreate user_has_access_to_province with VOLATILE
...
-- Recreate all the policies with the fixed functions
